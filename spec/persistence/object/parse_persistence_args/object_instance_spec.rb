...
describe ::Persistence::Object::ParsePersistenceArgs::ObjectInstance do
  ...
  it 'can parse args for indexed or non-indexed processing' do
    ...
    # 1 arg: index
    args = [ :index ]
    instance.parse_object_args_for_index_value_no_value( args ).should == [ ::Persistence::Object::ParsePersistenceArgs::Mock.index( :index ), nil, true ]
    # 2 args: index, key
    args = [ :index, :key ]
    instance.parse_object_args_for_index_value_no_value( args ).should == [ ::Persistence::Object::ParsePersistenceArgs::Mock.index( :index ), :key, false ]
    ...
    instance.persistence_port.persist_files_by_path!
    instance.parse_object_args_for_index_value_no_value( args ).should == [ ::Persistence::Object::ParsePersistenceArgs::Mock.index( :index ), ::Persistence::Object::Flat::File::Path.new( file_instance.path ), false ]
    instance.persistence_port.persists_files_by_content!
    instance.parse_object_args_for_index_value_no_value( args ).should == [ ::Persistence::Object::ParsePersistenceArgs::Mock.index( :index ), ::Persistence::Object::Flat::File::Contents.new( file_instance.readlines.join ), false ]
  end
