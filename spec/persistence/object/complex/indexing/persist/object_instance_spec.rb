...
describe ::Persistence::Object::Complex::Indexing::Persist::ObjectInstance do
  ...
  it 'indexes attributes during persist' do
    ...
    class ::Persistence::Object::Complex::Indexing::Persist::ObjectInstance::Mock
    ...
    instance = ::Persistence::Object::Complex::Indexing::Persist::ObjectInstance::Mock.new
    instance.attribute_index = :some_value
    # should call index_attributes
    instance.persist!
    instance_copy = ::Persistence::Object::Complex::Indexing::Persist::ObjectInstance::Mock.persist( :attribute_index, :some_value )
    instance_copy.should == instance
    instance_copy_two = ::Persistence::Object::Complex::Indexing::Persist::ObjectInstance::Mock.new
