...
describe ::Persistence::Object::Flat::File::ClassInstance do
  ...
  it 'can persist a flat object and test whether it has been persisted' do
    ...
    File.instance_persistence_port.persist_file_by_content
    persisted_file = File.persist( instance_to_persist.persistence_id )
    persisted_file.should == instance_to_persist

    # by path
    instance_to_persist_two = ::Persistence::Object::Flat::File::Path.new( instance.path )
    instance_to_persist_two.persistence_bucket = File.instance_persistence_bucket
    ...
    File.instance_persistence_port.persist_file_paths_as_objects
    persisted_file_two = File.persist( instance_to_persist_two.persistence_id )
