...
describe ::Persistence::Port::Bucket::AdapterInterface do
  ...
  it 'can serve as an adapter to a persistence bucket instance in an adapter instance' do
    ...
    instance = ::Persistence::Port::Bucket::AdapterInterface::Mock.new( :mock, :some_bucket )
    object = ::Persistence::Port::Bucket::AdapterInterface::MockClass.new
  ...
  it 'can serve as an adapter to a persistence bucket instance in an adapter instance' do
    ...
    instance = ::Persistence::Port::Bucket::AdapterInterface::Mock.new( :mock, :some_bucket )
    sub_object = ::Persistence::Port::Bucket::AdapterInterface::MockClass.new.instance_eval do
      @simple_var = :value
      self
    end
    sub_object.persistence_port = ::Persistence.port( :mock )
    sub_object.persistence_bucket = instance
    object = ::Persistence::Port::Bucket::AdapterInterface::MockClass.new.instance_eval do
