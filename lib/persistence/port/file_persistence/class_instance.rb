...
module ::Persistence::Port::FilePersistence::ClassInstance
  ...
  def persists_file_by_path?
    ...
    if ( should_persists_file_by_path = persists_file_by_path ) == nil
      should_persists_file_by_path = persistence_bucket.persists_file_by_path?
    end
  ...
  def persists_file_paths_as_strings?
    ...
    if ( should_persists_file_paths_as_strings = persists_file_paths_as_strings ) == nil
      should_persists_file_paths_as_strings = persistence_bucket.persists_file_paths_as_strings?
    end
  ...
  def persists_file_paths_as_objects?
    ...
    if ( should_persists_file_paths_as_objects = persists_file_paths_as_objects ) == nil
      should_persists_file_paths_as_objects = persistence_bucket.persists_file_paths_as_objects?
    end
